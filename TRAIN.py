...
EXP_DATA = 'WARN_14w_QP47-56_200810'  # naming model
...
# model_path = r"D:\0wzy\Tr\checkpoints\RVDSR_WARN_I_QP47-56_2008042020\RVDSR_WARN_I_QP47-56_2008042020_041_259.81.ckpt"
...
if __name__ == '__main__':
    ...
    with tf.name_scope('input_scope'):
        ...
        # train_output = model(x=train_input, nb_blocks=3, filters=8, training=tf.cast(True, tf.bool)).base_model
